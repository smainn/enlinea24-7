...
class EditarCongifEERR extends Component{
    ...
    get_data() {
        httpRequest('get', ws.wsconfigeerr + '/editar/' + this.props.match.params.id).then(
            response => {
                if (response.response == 1) {
                    console.log(response)
                    this.setState({
                        numaccion: response.data.numaccion,
                        operacion: response.data.operacion,
                        descripcion: response.data.descripcion == null ? '' : response.data.descripcion,
                        formula: response.data.formula == null ? '' : response.data.formula,
                        valorporcentual: response.data.valorporcentaje == null ? '' : response.data.valorporcentaje,
                        idcuentaplan: response.data.idcuentaplan == null ? '' : response.data.idcuentaplan,
    ...
    storeData() {
        ...
        httpRequest('post', ws.wsconfigeerr + '/update', body)
        .then((result) => {
            console.log(result)
                    ...
                    <div className="forms-groups">
                        <div className="pulls-left">
                            <h1 className="lbls-title">
                                EDITAR DEFINICION PARA ESTADO DE RESULTADO
                            </h1>
                        </div>
                    </div>
                    <div className="forms-groups">
...
export default withRouter(EditarCongifEERR);
