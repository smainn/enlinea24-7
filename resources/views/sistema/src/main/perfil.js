...
import routes from '../utils/routes'; //'../../tools/routes';
...
export default class PerfilUsuario extends Component {
    ...
    onSubmitData() {
        ...
        httpRequest('post', ws.wsusuarioperfil, body)
        .then(result => {
    ...
    onSubmitDataPassword() {
        ...
        httpRequest('post', ws.wsupdatepassword, body)
        .then(result => {
    ...
    imgPerfil() {
        ...
        if (this.state.foto == null || this.state.foto == '' || (typeof this.state.foto == undefined)) {
            return (
                <img src='/img/perfil.png' alt="none" 
        ...
        if (typeof user.is_file == 'boolean') {
            if (user.is_file) {
                return (
                    <img src={this.state.foto} alt="none" 
                        style={{'position': 'absolute',
                            'top': '0', 'left': '0',
                            'width': '100%', 'height': '100%',
                            'borderRadius': '50%',
