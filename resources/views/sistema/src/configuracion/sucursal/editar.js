...
class Editar_Sucursal extends Component{
    ...
    get_data() {
        httpRequest('get', ws.wssucursal + '/edit/' + this.props.match.params.id)
        .then(result => {
            if ( result.response == 1) {
                ...
                this.setState({
                    ...
                    tipoempresa: result.sucursal.tipoempresa,
                    tiposucursal: result.sucursal.tiposucursal,
                    nombrecomercial: (result.sucursal.nombrecomercial == null)?'':result.sucursal.nombrecomercial,
                    razonsocial: (result.sucursal.razonsocial == null)?'':result.sucursal.razonsocial,
                    nit: (result.sucursal.nit == null)?'':result.sucursal.nit,
                    nombre: (result.sucursal.nombre == null)?'':result.sucursal.nombre,
                    apellido: (result.sucursal.apellido == null)?'':result.sucursal.apellido,
                    idpais: result.sucursal.fkidpais,
                    idciudad: result.sucursal.fkidciudad,
                    zona: (result.sucursal.zona == null)?'':result.sucursal.zona,
                    direccion: (result.sucursal.direccion == null)?'':result.sucursal.direccion,
                    telefono: (result.sucursal.telefono == null)?'':result.sucursal.telefono,
                    logotipo: (result.sucursal.logotipourl == null)?'':result.sucursal.logotipourl,
    ...
    onSubmit() {
        ...
        httpRequest('post',  ws.wssucursal + '/update', body)
        .then((result) => {
            if (result.response == 1) {             
                message.success('exito en actualizar los datos');
                this.props.history.goBack();
            }
            ...
            <div className="rows">
                ...
                <div className="cards">
                    <div className="pulls-left">
                        <h1 className="lbls-title">Editar Sucursal</h1>
                    </div>
...
export default withRouter(Editar_Sucursal);
