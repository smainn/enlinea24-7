...
class Editar_Dosificacion extends Component{
    ...
    componentDidMount() {
        httpRequest('get', ws.wsdosificacion + '/edit/' + this.props.match.params.id)
        .then((result) => {
            if (result.response == 1) {
                this.setState({
                    ...
                    nrotramite: result.dosificacion.numerotramite,
                    fecha_activacion: convertDmyToYmd(result.dosificacion.fechaactivacion),
                    nroautorizacion: result.dosificacion.numeroautorizacion,
                    idsucursal: result.dosificacion.fkidsucursal,
                    nit: result.dosificacion.nit,
                    idactividadeconomica: result.dosificacion.fkidfacactividadeconomica,
                    sfcsistema: result.dosificacion.nombresfcmarca,
                    fecha_limite: convertDmyToYmd(result.dosificacion.fechalimiteemision),
                    llave: result.dosificacion.llave,
                    descripcion: (result.dosificacion.descripcion == null)?'':result.dosificacion.descripcion,
                    nrofacturainicial: result.dosificacion.numfacturainicial,
                    nrofacturasiguiente: result.dosificacion.numfacturasiguiente,
                    titulo: result.dosificacion.titulo,
                    subtitulo: (result.dosificacion.subtitulo == null)?'':result.dosificacion.subtitulo,
                    leyendauno: result.dosificacion.leyenda1piefactura,
                    leyendados: result.dosificacion.leyenda2piefactura,
                    tipopapel: result.dosificacion.tipofactura,
                    estado: result.dosificacion.estado,
                    plantillafactura: result.dosificacion.plantillafacturaurl,
    ...
    onSubmit(event) {
        ...
        httpRequest('post', ws.wsdosificacion + '/update', body)
        .then(result => {
            if(result.response == 1){
                ...
                <div className="cards" style={{'padding': 0}}>
                    <div className="forms-groups">
                        <div className="pulls-left">
                            <h1 className="lbls-title">1. Editar dosificación de facturas </h1>
                        </div>
                    </div>
                    <div className="forms-groups">
                        <C_Input
                    ...
                    <div className="forms-groups">
                        ...
                        <C_Select 
                            ...
                            component={[
                                ...
                                <Option key={2} value={'F'}> {'Finalizado'} </Option>,
                            ]}
                        />
                        <C_Input
...
Editar_Dosificacion.propTypes = {
    style: PropTypes.object,
}

Editar_Dosificacion.defaultProps = {
    style: {},
}

export default withRouter(Editar_Dosificacion);
