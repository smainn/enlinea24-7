...
class CrearTipoCambio extends Component{
    ...
    componentDidMount() {
        httpRequest('get', ws.wstipocambio + '/create')
        .then((result) => {
    ...
    onSubmit(event) {
        ...
        httpRequest('post', ws.wstipocambio + '/store', body)
        .then(result => {
            if(result.response == 1){
                ...
                <div className="cards" style={{'padding': 0}}>
                    <div className="forms-groups">
                        <div className="pulls-left">
                            <h1 className="lbls-title">Nuevo tipo de cambio </h1>
                        </div>
                    </div>
                    <div className="forms-groups">
...
CrearTipoCambio.propTypes = {
    style: PropTypes.object,
}

CrearTipoCambio.defaultProps = {
    style: {},
}

export default withRouter(CrearTipoCambio);
