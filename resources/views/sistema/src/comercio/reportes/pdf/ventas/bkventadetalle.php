                ...
                <?php foreach ($venta as $v) { ?>
                    ...
                    <thead>
                        <?php if ($id != $v->idventa) { ?>
                            ...
                            <?php if ($bandera == 1) { ?>
                                <tr>
                                    <td colspan="<?= $colcount ?>" style="text-align: right; padding-bottom: 15px; border-bottom: 4px double #e8e8e8">
                                        <strong>
                                            Total Venta:
                                            <label style="font-weight: 400; padding-left: 50px; padding-right: 8px;">
                        ...
                        <tr>
                            ...
                            <?php if ($permisos->t_cantidad->visible == 'A') { ?>
                                <td style="font: 300 14px Roboto; text-align: right; padding-right: 10px;">
                                    <?= $v->cantidad ?>
                                </td>
                            <?php } ?>
                            ...
                            <td style="font: 300 14px Roboto; text-align: right; padding-right: 10px;">
                                ...
                                <?= number_format((float)round( round(($v->cantidad * $v->precio) - (($v->cantidad * $v->precio)*($v->descuento/100)), 2) ,2, PHP_ROUND_HALF_DOWN),2,'.',',') ?>
