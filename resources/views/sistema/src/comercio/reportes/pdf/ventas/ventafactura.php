...
<html lang="es">
    <head>
        ...
        <style>
            ...
            .table-report tbody tr td.txt_tr {
                font: normal 8px Roboto,RobotoDraft,Helvetica,Arial,sans-serif;
            }
        </style>
            ...
            <table class="table-report" style="margin-bottom: 15px;">
                ...
                <tbody>
                    <?php foreach ( $factura as $fact ) { ?>
                        <tr>
                            <td class="txt_tr">
                                <?= $fact->nroautorizacion ?>
                            </td>
                            <td class="txt_tr">
                                <?= $fact->codigodecontrol ?>
                            </td>
                            <td class="txt_tr">
                                <?= $fact->numero ?>
                            </td>
                            <td class="txt_tr">
                                <?= date("d/m/Y", strtotime($fact->fecha)) ?>
                            </td>
                            <td class="txt_tr">
                                <?= $fact->idventa ?>
                            </td>
                            ...
                            <td class="txt_tr">
                                <?= $fact->nit == 0 ? 'S/N' : $fact->nit ?>
                            </td>
                            <td class="txt_tr" style="text-align: right; padding-right: 5px;">
                                <?= number_format((float)round( $fact->mtototalventa ,2, PHP_ROUND_HALF_DOWN),2,'.',',') ?>
                                <?php 
                                    $mtoTotal += $fact->mtototalventa;
                                ?>
                            </td>
                            <td class="txt_tr">
                                <?= $fact->estado == 'V' ? 'Activo' : 'Anulado' ?>
                            </td>
                            <td class="txt_tr" style="text-align: right; padding-right: 5px;">
                                <?= $fact->contadordelimpresion ?>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
                <tbody>
                    <tr>
                        <td class="txt_tr" colspan="7" style="text-align: right; padding-right: 5px; font-weight: bold;">
                            Total: 
                        </td>
                        <td class="txt_tr" style="text-align: right; padding-right: 5px;">
