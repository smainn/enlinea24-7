                    ...
                    <tr>
                        <th style="border-bottom: 1px dashed #000000;">
                            <div style="width: 100%; text-align: center;">
                                ...
                                <label style="font-size: 18px; letter-spacing: 2px;
                            ...
                            <div style="width: 100%;">
                                <div style="width: 25%; padding: 6px;">
                                    <label style="font-size: 12px; padding-left: 5px;">
                                        <strong style="font-size: 13px;">CodVenta: </strong> 
                                        &nbsp; <?= $venta->idventa ?> 
                                    </label>
                                </div>
                    ...
                    <tr>
                        <td>
                            <div style="width: 100%;">
                                ...
                                <div style="padding: 6px; margin-top: -50px">
                                    <label style="font-size: 12px; padding-left: 10px;">
                                        <strong style="font-size: 13px;">TC: </strong> 
                                        &nbsp; <?= $venta->tc == 0 ? number_format((float)round( 1 ,2, PHP_ROUND_HALF_DOWN),2,'.',',') : number_format((float)round( $venta->tc ,2, PHP_ROUND_HALF_DOWN),2,'.',',') ?> 
                                    </label>
                                </div>
                            </div>
                        </td>
                ...
                <?php if ($permisos->anticipo->visible == 'A') { ?>
                    <div style="width: 100%;">
                        <label style="padding: 5px; font-size: 12px;">
                            <strong style="font-size: 13px;">Anticipo: </strong> &nbsp; <?= $venta->anticipo ?>
                        </label>
                    </div>
                <?php } ?>
