...
export default class Reporte_Log extends Component{
    ...
    render() {
        ...
        return (
            <PDFViewer style={{width: '100%', maxWidth: '100%', height: '100vh',}}>
                <Document title={'REPORTE LOG DEL SISTEMA'} onRender={() => this.setState({visible_reporte: false, }) }>
                    <Page size="A4" orientation='landscape' style={styles.body}>
                        ...
                        {/* {((this.state.logo == '' || this.state.logo == null) && index != this.state.array_data.length) ? null : 
                            <Image style={{ left: 30, position: 'absolute', top: 10, width: 90, height: 40, borderRadius: 5, }} 
                                src={this.state.logo}
                            />
                        } */}
