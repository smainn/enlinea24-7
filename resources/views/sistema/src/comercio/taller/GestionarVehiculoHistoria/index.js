...
class IndexVehiculoHistoria extends Component{
            ...
            if(result.response == 1){
                ...
                for (let i = 0; i < data.length; i++) {
                    ...
                    datosHistoriaVehiculos.push({
                        ...
                        fecharecibida: convertYmdToDmy(data[i].fecha),
                        ...
                        proximafecha: convertYmdToDmy(data[i].fechaproxima)
                    });
                }
                this.setState({
    ...
    showVehiculoHistoria(id) {
        ...
        httpRequest('post', ws.wsshowvehiculohistoria, data)
        .then(result =>{
    ...
    onSubmitEliminar(e) {
        ...
        httpRequest('post', ws.wsvehiculohistoriaanular, {
    ...
    btnEditar(item) {
        if (item.fkidventa == null) {
            return (
                <Link to={routes.vehiculo_historia_edit + '/' + item.id}
    ...
    onCreateData() {
        var url = routes.vehiculo_historia_create;
