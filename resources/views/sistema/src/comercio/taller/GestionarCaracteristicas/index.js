...
class IndexVehiculoCaracteristica extends Component {
    ...
    onOkMC() {
        ...
        this.eliminarCaracteristica(this.state.idDelete);
        this.setState({
            modalCancel: false,
        })
    }
    ...
    btnEliminar(data) {
        if (this.permisions.btn_eliminar.visible == 'A') {
            return (
                <a onClick={() => this.setState({ modalCancel: true, idDelete: data }) }//this.showDeleteConfirm(this, data)}
        ...
        return (
            <div className="rows">
                ...
                <Confirmation
                    ...
                    title="Eliminar Caracteristica de Vehiculo"
                    ...
                    content = {[
                        <div className="cols-lg-12 cols-md-12 cols-sm-12 cols-xs-12" key={0}>
                            <label>
                                ¿Esta seguro de eliminar la Caracteristica de Vehiculo?
                            </label>
                        </div>
                    ]}
                />
