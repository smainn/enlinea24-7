...
export default class IndexFamilia extends Component{
    ...
    onSubmitCrear(e) {
        ...
        if (this.state.descripcionFamilia.length > 0) {
            ...
            httpRequest('post',  ws.wsfamiliastore, body)
            .then((resp) => {
                if (resp.response === 1) {
                    this.setState({
                        arbolFamilia: resp.data
                    ...
                    const WooCommerce = new WooCommerceRestApi({
                        url: "https://test.enlinea24-7.com/",
                        consumerKey: "ck_dc07f396970de1e1cba9917f80776f87c1f18d34",
                        consumerSecret: "cs_67690bb65e9251f007130af6b1e9d61d351054c5",
                        version: "wc/v3",
                        queryStringAuth: true,
                    });

                    const datawoocommerce = {
                        name: this.state.descripcionFamilia,
                    };
    ...
    onSubmitEliminar(e) {
        ...
        httpRequest('post', ws.wsfamiliaanular, {
            idPadre: this.state.idFamiliaElegido
        })
        .then((resp) => {
            if (resp.response === 1) {
