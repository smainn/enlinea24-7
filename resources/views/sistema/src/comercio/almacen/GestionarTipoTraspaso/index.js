...
export default class IndexTipoTraspaso extends Component {
    ...
    onOkMC() {
        ...
        this.deleteTipoTraspaso(this.state.idDelete);
        this.setState({
            loadingC: true
        })
    }
    ...
    getTipoTraspasos(){
        ...
        .then((result) => {
            ...
            console.log(error);
            messsage.error(strings.message_error);
        });
    }
        ...
        return (
            ...
            <div className="rows">
                    ...
                    <Confirmation
                        ...
                        title="Eliminar Tipo de Traspaso"
                        ...
                        content = {[
                            <div className="cols-lg-12 cols-md-12 cols-sm-12 cols-xs-12" key={0}>
                                <label>
                                    ¿Esta seguro de eliminar el tipo de traspaso?
                                </label>
                            </div>
                        ]}
                    />
                <div className="cards">
                    <div className="pulls-left">
                        <h1 className="lbls-title">Gestionar Tipo MovimientoAlmacen</h1>
                    </div>
                    { btnNuevo }
                    <div className="forms-groups">
                        <div className="pulls-left">
