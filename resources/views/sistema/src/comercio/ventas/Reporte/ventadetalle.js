...
export default class Reporte_Venta_Detalle extends Component{
                ...
                <div className="cards">
                    <div className="forms-froups">
                        <div className="pulls-left">
                            <h1 className="lbls-title">Reporte Venta Detalle</h1>
                        </div>
                    </div>

                    <div className="forms-groups">
                        <form action={routes.reporte_venta_detallado} target="_blank" method="post">
                                                    ...
                                                    (data, key) => ((key == 0)?
                                                        [
                                                            ...
                                                            <Option key={key} value={data.idsucursal}>
                                                                {
                                                                    data.tipoempresa == null ? 'S/Empresa' : data.tipoempresa == 'N' ? 
                                                                        data.nombrecomercial == null ? 'S/Empresa' : data.nombrecomercial :
                                                                        data.razonsocial == null ? 'S/Empresa' : data.razonsocial
                                                                }
                                                            </Option>
                                                        ]:
                                                            <Option key={key} value={data.idsucursal}>
