    ...
    componentvendedoradmin() {
        ...
        if (this.state.fkidgrupo != 3) {
            return (
                <>
                    <C_Input
                        className="cols-lg-5 cols-md-5 cols-sm-5 cols-xs-12"
                                ...
                                <div className="cols-lg-3 cols-md-3 cols-sm-3 cols-xs-12">
                                    <div className="inputs-groups">
                                        <input type="text"
                                            ...
                                            readOnly={(this.state.opcion != '')?false:true}
                                        />
                                        <label style={{'color': (this.state.opcion != '')?'#f52b50':'#e8e8e8'}}  //4476FA
