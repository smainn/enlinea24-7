...
import { httpRequest, removeAllData, saveData, readData } from '../../utils/toolsStorage';
...
export default class EditarUsuario extends Component{
    ...
    onSubmitUpdate(event) {
        ...
        httpRequest('post', ws.wsusuarioupdate, body)
        .then(result => {
    ...
    onGenerarPassword(event) {
        ...
        if (this.state.emailusers.toString().trim().length == 0) {
            ...
            httpRequest('post', ws.wsusuariogenerarpw, body)
            .then(result => {
