...
import SelectPaginate from '../../componentes/selectPaginate';
...
export default class AsignarPrivilegio extends Component {
    ...
    getGrupoUsuario(page, buscar, nroPaginacion) {
        ...
        httpRequest('get', ws.wspermisioindex + '?page=' + page + '&buscar=' + buscar + '&pagina=' + nroPaginacion + '&id=' + id)
        .then(result => {
            if (result.response == 0) {
            } else if (result.response == 1) {
    ...
    getPermisosDelGrupo(idGrupoUsuario) {
        ...
        if (id == 1 || id == 2) {
            ...
            httpRequest('post', ws.wsgetpermisos, formData)
            .then(result => {
                if (result.response == 0) {
                } else if (result.response == 1) {
    ...
    onsubmitGuardarDatos(event) {
        ...
        httpRequest('post', ws.wspermisionstore, body)
        .then(result => {
