...
export default class EditarGrupoUsuario extends Component{
    ...
    componentDidMount() {
        httpRequest('get', ws.wsgrupousuarioedit + '/' + this.props.match.params.id + '')
        .then(result => {
            ...
            if (result.response == 0) {
                ...
                this.setState({
                    ...
                    usuariosConGrupo: result.usuariogrupo,
                });
    ...
    usuariosConGrupos() {
        ...
        this.state.usuariosConGrupo.map(
            (response, key) => {
                ...
                if (typeof this.state.bandera[key] == 'undefined') {
                    this.state.bandera[key] = 0;
                }
    ...
    onSubmitGuardarDatos(event) {
        ...
        let body = {
            ...
            usuariossingrupo: JSON.stringify(this.state.usuarios),
            id: this.props.match.params.id,
            idusuario: idusuario
        };
        httpRequest('post', ws.wsgrupousuarioupdate, body)
        .then(result => {
            ...
            if (result.response == 1) {
                ...
                message.success('Exito en editar grupo de usuario');
                this.setState({
                    redirect: true,
                });
            }
        ...
        if (this.state.sw == 1) {
            return (
                <Confirmation
                    ...
                    title = '¿Esta seguro de cancelar la actualizacion del Grupo?'
    ...
    render() {
        ...
        if (this.state.redirect) {
            return (<Redirect to={routes.grupo_usuario_index} />);
        }
        return (
            <div className="rows">
                ...
                <div className="cards">
                    ...
                    <div className="pulls-left">
                        <h1 className="lbls-title">Editar Grupo Usuario</h1>
                    </div>
