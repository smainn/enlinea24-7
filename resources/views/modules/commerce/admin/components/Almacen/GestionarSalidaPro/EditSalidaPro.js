...
export default class EditIngresoPro extends Component{
    ...
    handleCodSalidaPro(e) {
        this.setState({
            codsalidaprod: e.target.value
        });
    }
    ...
    updateSalidaProducto(e) {
        ...
        axios.put(wssalidaproducto + '/' + this.props.match.params.id, body)
        .then((resp) => {
            let result = resp.data;
            console.log('RESP SERVE UPDATE ',result);
            if (result.response > 0) {
    ...
    async getSalidaProducto() {
        axios.get(wssalidaproducto + '/' + this.props.match.params.id + '/edit')
        .then((resp) => {
            let result = resp.data;
            console.log('RESP SALIDA', result);
            if (result.response > 0) {
                ...
                this.setState({
                    codsalidaprod: salidaprod.codsalidaprod,
    ...
    render(){
        ...
        if (this.state.redirect) {
            return (
                <Redirect to="/commerce/admin/salidaprod/index"/>
            )
        }
            ...
            <div>
                <div className="card-header-content">
                    <div className="pull-left-content">
                        <h1 className="title-logo-content"> Editar Salida de Produco </h1>
                    </div>
                </div>
                ...
                <form 
                    ...
                    onSubmit={this.updateSalidaProducto}
                >
