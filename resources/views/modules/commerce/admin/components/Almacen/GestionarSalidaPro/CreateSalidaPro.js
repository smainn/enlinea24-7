...
export default class CreateSalidaPro extends Component{
    ...
    storeSalidaProducto(e) {
        ...
        axios.post(wssalidaproducto, body)
        .then((resp) => {
            let result = resp.data;
            ...
            <div>
                <div className="card-header-content">
                    <div className="pull-left-content">
                        <h1 className="title-logo-content"> Registrar Salida Producto </h1>
                    </div>
                </div>
                ...
                <form 
                    ...
                    onSubmit={this.storeSalidaProducto}
                >
                    ...
                    <div className="form-group-content col-lg-12-content">
                        <div className="col-lg-12-content">
                            ...
                            <div className="col-lg-3-content">
                                ...
                                <label 
                                    htmlFor="tipo" 
                                    className="label-content"> Tipo Salida 
                                </label>
                            </div>
