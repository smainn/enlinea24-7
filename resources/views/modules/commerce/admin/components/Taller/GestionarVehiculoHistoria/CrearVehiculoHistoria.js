...
export default class CrearVehiculoHistoria extends Component{
    ...
    onSubmitGuardarDatos(e) {
        ...
        if ((this.state.idCliente != 0) && (this.state.idVehiculo != 0) && 
            ...
            axios.post('/commerce/admin/postVehiculoHistoria', formData).then(
                response => {          
    ...
    onChangeShow() {
        return (
            <Modal
                ...
                title='Registrar Historia Vehiculo'
    ...
    render() {
        ...
        return (
            <div className="row-content"
                style={{'display': (!this.props.visibleCrear)?'none':'block'}}>

                {componentShow}

                <div className="card-header-content">
                    <div className="pull-left-content">
                        <h1 className="title-logo-content"> Registrar Historia Vehiculo </h1>
                    </div>
                    <div className="pull-right-content">
                        ...
                        <div className="form-group-content" style={{'padding': '0 0 0 0'}}>
                            ...
                            <div className="col-lg-12-content col-md-12-content col-sm-12-content col-xs-12-content"
                                ...
                                <div className="col-lg-3-content col-md-3-content col-sm-12-content col-xs-12-content"
                                    onClick={this.cerrarSeleccionCliente.bind(this)}>
                                    <div className="input-group-content" >
                                        <select value={(this.state.idVehiculo === 0)?'':this.state.idVehiculo} 
