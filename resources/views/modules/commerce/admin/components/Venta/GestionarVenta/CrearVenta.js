...
import { Modal,TreeSelect,message,notification ,Icon,Divider} from 'antd';
            ...
            <div>
                ...
                >
                    <ShowCliente contactoCliente={this.state.clienteContactarloSeleccionado} 
                        cliente={this.state.clienteSeleccionado}></ShowCliente>
                        ...
                        <div>
                                ...
                                <div className="col-lg-2-content col-md-2-content col-sm-12-content col-xs-12-content">
                                    <div className="input-group-content">
                                        ...
                                        <label htmlFor="nitCliente"
                                               className="label-group-content"> Nit </label>
                                    </div>
                                </div>
                                <div className="col-lg-2-content col-md-2-content col-sm-12-content col-xs-12-content">
                                    <div className="input-group-content">
                                        ...
                                        <label htmlFor="moneda"
                                               className="label-group-content"> Moneda </label>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div className="col-lg-1-content col-md-1-content col-sm-12-content col-xs-12-content">
                                                    <div className="input-group-content">
                                                        <a className="btn-content btn-danger-content hint--bottom "
                                                           aria-label="Eliminar" style={{ marginLeft:30}}>
                                                            <i className="fa fa-remove" onClick={this.removeRowDetalle.bind(this,i)}> </i>
                                                        </a>
                                                    </div>
                                                </div>
                                                <Divider/>
                            ...
                            <div className="form-group-content">
                                <div className="text-center-content">
                                    ...
                                    <div className="col-lg-2-content col-md-3-content col-sm-12-content col-xs-12-content">
                                        <button type="submit" className="btn-content btn-sm-content btn-success-content" onClick={this.pagar.bind(this)}>
                                            Pagar
                                        </button>
                                    </div>
                                    <div className="col-lg-2-content col-md-3-content col-sm-12-content col-xs-12-content">
