...
import { message, Modal, Select, Divider, DatePicker,Button, TreeSelect, Result } from 'antd';
...
export default class EditInventarioCorte extends Component{
    ...
    */
    ...
    calcularStocksNuevosTotal(index) {
        ...
        console.log('ARRAY ALMACENES INDEX ', array);
        console.log('SELECT ALMACENES ', this.state.selectAlmacenes);
        let length = array.length;
        let total = 0;
        for (let i = 0; i < length; i++) {
            ...
            <div>
                ...
                <div className="form-group-content">
                    ...
                    <button 
                            ...
                            onClick={this.showConfirmStore.bind(this,'P')}>
                            Guardar y quedar abierto
                        </button>
                        <button 
                            type="button" 
                            className="btns btns-primary"
                            onClick={this.showConfirmStore.bind(this,'F')}>
                            Guardar y finalizar
                        </button>
                        <button
