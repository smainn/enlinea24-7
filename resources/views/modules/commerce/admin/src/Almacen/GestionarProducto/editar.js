...
export default class EditProducto extends Component {
    ...
    componentStockAlmacen() {
        ...
        //if (this.state.isProducto) {
            //if (this.state.isProducto2) {
                ...
                return (
                    <div className="cols-lg-12 cols-md-12 cols-sm-12 cols-xs-12 margin-group-content">
                        ...
                        <div className="cols-lg-12 cols-md-12 cols-sm-12 cols-xs-12">
                            ...
                            <div className="cols-lg-1 cols-md-1 cols-sm-4 cols-xs-12 txts-center">
                                <h4>Stock Minimo</h4>
                            </div>
                            ...
                            <div className="cols-lg-4 cols-md-4 cols-sm-6 cols-xs-12 txts-center">
                                <h4>Ubicacion</h4>
                            </div>
                                        ...
                                        <div 
                                            ...
                                            <div className="cols-lg-1 cols-md-1 cols-sm-12 cols-xs-12">
                                                <Input
                                                    ...
                                                    readOnly={!this.state.isProducto || !this.state.configEditStock}
                                                />
                                            </div>
                                            ...
                                            <div className="cols-lg-1 cols-md-1 cols-sm-1 cols-xs-12">
            ...
            if (this.state.isProducto2) {
                return (
                    <div className="form-group-content col-lg-10-content margin-group-content">
                        ...
                        <div className="row cols-lg-12 cols-md-12 cols-sm-12 cols-xs-12">
    ...
    render() {
        ...
        if (this.state.redirect) {
            return (
                <Redirect to="/commerce/admin/producto"/>
            );
        }
                ...
                <div className="rows">
                    ...
                    <div className="cols-lg-12 cols-md-12 cols-sm-12 cols-xs-12">
                        <div className="txts-center">
                            <C_Button onClick={this.showConfirmEdit.bind(this)}
                                type='primary'
                                title='Guardar'
                            />
