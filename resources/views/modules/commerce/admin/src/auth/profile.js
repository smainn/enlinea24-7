        ...
        const loginRegLink = (
            <ul className="navbar-nav">
                <li className="nav-item">
                    ...
                    <Link to="/commerce/admin/login" className="nav-link">Login</Link>
                </li>
            </ul>
        );
        ...
        const userLink = (
            <ul className="navbar-nav">
                <li className="nav-item">
                    ...
                    <Link to="/commerce/admin/profile" className="nav-link">Profile</Link>
                </li>
                <li className="nav-item">
                    <a href="/commerce/admin" onClick={this.logout.bind(this)} className="nav-link">Logout</a>
                </li>
            </ul>
        );
