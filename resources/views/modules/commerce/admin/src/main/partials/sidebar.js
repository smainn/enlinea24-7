...
class Sidebar extends Component {
    ...
    reporteventas() {
        ...
        const permisionsRepComision = readPermisions(keys.ventas_reportes_comision_vend);
        ...
        return [
            ...
            <MenuItem 
                ...
                data={this.state.rootSubLinkMenuKey}
                onClick={this.onClickMenuSubLink.bind(this)}
                permisions={permisionsRepComision}
            />,
            <MenuItem 
                key={8} 
                onLink={this.onLink.bind(this, 'reporteventaporproducto')}
    ...
    subContable() {
        return [
            <MenuItem
                key={0}
                onLink={this.onLink.bind(this, 'plandecuenta')}
