    ...
    getConfigsClient() {
        ...
        .then((result) => {
            if (result.response == 1) {
                this.setState({
                    codigoPropios: result.data.codigospropios,
                });
                ...
                <div className="cards">
                    <div className="forms-froups">
                        <div className="pulls-left">
                            <h1 className="lbls-title">Reporte Comision por Vendedor</h1>
                        </div>
                    </div>

                    <div className="forms-groups">
                        <form action="/commerce/admin/comision_por_vendedor/generar" target="_blank" method="post">
                            ...
                            <div className="cols-lg-12 cols-md-12 cols-sm-12 cols-xs-12">
                                ...
                                <C_Select 
                                    ...
                                    component={[
                                        <Option key={0} value={1}> Id Vendedor </Option>,
