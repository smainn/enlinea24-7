...
export default class ReporteVentaHistoricoVehiculo extends Component{
    ...
    getPlaca(page, value) {
        var url = '/commerce/api/venta/reporte_historico_vehiculo?page=' + page + '&buscar=' + value;
        httpRequest('get', url)
        .then(result => {
        ...
        return (
            <div className="rows">
                ...
                <div className="cards">
                    ...
                    <form action="/commerce/admin/venta_historico_vehiculo/generar" target="_blank" method="post">
