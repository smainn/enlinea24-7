...
import { dateToString, dateToStringB, stringToDate } from '../../../tools/toolsDate';
...
export default class CreateProforma extends Component{
    ...
    constructor(props){
        ...
        this.state = {
            ...
            codigoVenta: "",
            fechaVenta: dateToString(dateNow),
    ...
    validarDatos() {
        ...
        if (this.state.codigoVenta.length === 0 && this.state.configCodigo) {
    ...
    guardarVenta(){
        /*
        console.log('codigoVenta', this.state.codigoVenta);
        console.log('fechaVenta',this.state.fechaVenta);
        console.log('comisionvendedor',this.state.comisionvendedor);
        console.log('idusuario',this.state.idusuario);
        console.log('estado',this.state.estado);
        console.log('estadoProceso',this.state.estadoProceso);
        console.log('sucursalVentaId',this.state.sucursalVentaId);
        console.log('valSearchClieCod',this.state.valSearchClieCod);
        console.log('valSearchVendedorCod',this.state.valSearchVendedorCod);
        console.log('fkidtipocontacredito',this.state.fkidtipocontacredito);
        console.log('fkidtipotransacventa',this.state.fkidtipotransacventa);
        */
