            ...
            <tbody>
                @foreach ($vehiculo as $v)
                    <tr>
                        ...
                        <td style="border-color:#666666; border-top-style: dashed; border-right-style: dashed; border-width: 1px; padding: 5px">{{($v->tipopartpublic == 'R'?'Privado':'Publico')}}</td>

                        <td style="border-color:#666666; border-top-style: dashed; border-width: 1px; padding: 5px">{{$v->nombre.' '.$v->apellido}}</td>
                    </tr>
