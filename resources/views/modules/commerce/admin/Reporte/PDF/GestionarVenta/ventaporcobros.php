...
<html>
    ...
    <style>
        ...
        .table-report thead tr td {
            ...
            font: bold 15px Roboto,RobotoDraft,Helvetica,Arial,sans-serif;
            cursor: pointer;
        }
        .table-report tbody {
            width: 100%;
        ...
        <table class="table-report">
            ...
            <tbody>
                <?php foreach ($venta as $v) { ?>
                    ...
                    <tr>
                        ...
                        <td class="txt-right"><?= $v->montoapagar ?>
                            <?php $totalCobrado = $totalCobrado + $v->montoapagar ?>
                        </td>

                        <td class="txt-right"><?= $v->montocobrado ?>
            ...
            <tbody>
                <tr>
                    ...
                    <td colspan="7" class="txt-right"> Total Por Cobrar:</td>

                    <td class="txt-right"><?= $totalCobrado ?></td>
