...
<html>
    ...
    <div style="width: 100%; display: flex; justify-content: center; 
            align-items: center;">
        <h1 style="font-weight: 100; font-size: 20px; text-align: center;">
            ...
            <tbody>
                <?php foreach ($venta as $v) { ?>
                    <tr>
                        ...
                        <td style="text-align: right; padding-right: 10px;"><?= $v->precio ?></td>
                        <td style="text-align: right; padding-right: 10px;"><?= $v->cantidad*$v->precio ?></td>
                    </tr>
                <?php } ?>
                <tr>
                    ...
                    <td style="text-align: right; padding-right: 10px;"><?= $cantidadTotal ?></td>
                    <td style="text-align: right; padding-right: 10px;">
                        <strong>
                            Total Precio Vendido: 
                        </strong>
                    </td>
                    <td style="text-align: right; padding-right: 10px;"><?= $precioTotal ?></td>
                </tr>
            </tbody>
        </table>
    </div>
